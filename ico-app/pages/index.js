...
export default function Home() {
  ...
  const getProviderOrSigner = async (needSigner = false) => {
    ...
    // Providers are to read the values on the blockchain
  ...
  // Users should be able to connect when they open the website
  useEffect(() => {
    if (!walletConnected) {
  ...
  return (
    <div>
      ...
      <div>
        <footer className={styles.footer}>Made with &#10084; by Jeff</footer>
      </div>
    </div>
  );
}
